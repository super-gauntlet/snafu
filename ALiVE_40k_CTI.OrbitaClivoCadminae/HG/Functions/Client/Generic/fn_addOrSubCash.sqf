...
_oldVal = if(_where isEqualTo 0) then {(CASH_VAR getVariable HG_CASH_VAR)} else {(CASH_VAR getVariable HG_BANK_VAR)};
...
{
    CASH_VAR setVariable [HG_CASH_VAR,_newVal,true];
    ...
    CASH_VAR setVariable [HG_BANK_VAR,_newVal,true];
};
