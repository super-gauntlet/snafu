...
switch(_mode) do
{
	...
	case 1:
	{
		HG_HUD_MONEY_TEXT ctrlSetText format["%1",([(CASH_VAR getVariable HG_CASH_VAR)] call BIS_fnc_numberText)];
	};
	// HUD XP Update
	case 2:
	{
	...
	case 4:
	{
	    HG_HUD_KILL_COUNT_TEXT ctrlSetText format["%1",(CASH_VAR getVariable "HG_Kills")];
	};
	// HUD Off
	case 5:
	{
