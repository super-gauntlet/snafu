...
switch(_mode) do
{
    ...
    case 0:
	{
	    if(_amount > (CASH_VAR getVariable HG_CASH_VAR)) exitWith {hint (localize "STR_HG_ATM_CANNOT_DEPOSIT");};
	...
	case 1:
	{
	    if(_amount > (CASH_VAR getVariable HG_BANK_VAR)) exitWith {hint (localize "STR_HG_ATM_CANNOT_WITHDRAW");};
	...
	case 2:
	{
	    if(_amount > (CASH_VAR getVariable HG_BANK_VAR)) exitWith {hint (localize "STR_HG_ATM_CANNOT_TRANSFER");};
