...
HG_ATM_ACC_TEXT ctrlSetText ([(CASH_VAR getVariable HG_BANK_VAR),true] call HG_fnc_currencyToText);
HG_ATM_CASH_TEXT ctrlSetText ([(CASH_VAR getVariable HG_CASH_VAR),true] call HG_fnc_currencyToText);
